                ...
                <div className="flex flex-row relative h-[300px]">
                    ...
                    <div className="w-1/2 flex justify-center pt-15">
                        <div onClick={() => setOpen(!isOpen)} className="relative w-[353px] h-[60px]">
                            <div className="relative flex justify-between cursor-pointer hover:shadow-active active:bg-border px-4 box-border items-center w-[353px] h-[60px] bg-base rounded-4">
                                <p className="m-0">{algorithm}</p>
                                <div className="mt-[-10px]">
                                    <CoworkingIcon icon={Icon.arrow} edgeLength={10} />
                                </div>
                            </div>
                            {isOpen && (
                                <CoworkingSelector list={[ 'Длинное название алгоритма 1', 'Длинное название алгоритма 2', 'Длинное название алгоритма 3',]} onClick={setAlgorithm} />
                            )}
                        </div>
                    </div>
                </div>
